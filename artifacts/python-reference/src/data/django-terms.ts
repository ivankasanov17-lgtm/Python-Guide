    ...
    },
    {
        ...
        arguments: [
            ...
            },
            {
                name: "obj",
                description:
                    "Необязательный объект, к которому относится сообщение.",
            },
            {
                name: "id",
                description:
    ...
    },
    {
        ...
        arguments: [
            ...
            },
            {
                name: "--database DATABASE",
                description:
                    "Алиас БД из DATABASES, которую очищать. По умолчанию default. Для каждой БД flush нужно вызывать отдельно.",
            },
        ],
...
# поэтому оптимизация безопасна для будущих fresh-инсталляций.`,
    },
    {
        ...
        syntax: "manage.py runserver [addrport] [--noreload] [--nothreading] [--ipv6/-6]",
        arguments: [
            {
                name: "addrport",
                description:
...
$ uvicorn myproject.asgi:application --host 0.0.0.0 --port 8000`,
    },
    {
        ...
        syntax: "manage.py sendtestemail [email [email ...]] [--managers] [--admins]",
        arguments: [
            {
                name: "email [email ...]",
                description:
...
#   - проверить логи провайдера (отказ, отбракованный получатель)`,
    },
    {
        ...
        syntax: "manage.py shell [-i {ipython,bpython,python}] [--no-startup] [--no-imports] [-c COMMAND]",
        arguments: [
            {
...
$ python manage.py shell_plus`,
    },
    {
        ...
        syntax: "manage.py showmigrations [app_label [app_label ...]] [--list/-l] [--plan/-p] [--database DATABASE]",
        arguments: [
            {
                name: "app_label [app_label ...]",
                description:
...
# собственные TRUNCATE.`,
    },
    {
        ...
        syntax: "manage.py sqlmigrate app_label migration_name [--backwards] [--database DATABASE]",
        arguments: [
            {
                name: "app_label",
                description:
...
# Для RunPython вы увидите комментарий "-- Raw Python operation".`,
    },
    {
        ...
        syntax: "manage.py sqlsequencereset app_label [app_label ...] [--database DATABASE]",
        arguments: [
            {
                name: "app_label [app_label ...]",
                description:
...
COMMIT;`,
    },
    {
        ...
        syntax: "manage.py squashmigrations app_label [start_migration_name] migration_name [--no-optimize] [--noinput/--no-input] [--squashed-name SQUASHED_NAME] [--no-header]",
        arguments: [
            {
                name: "app_label",
                description:
                    "Метка приложения, миграции которого нужно сжать.",
            },
            {
            ...
            },
            {
                name: "--noinput, --no-input",
                description:
                    "Не задавать интерактивных вопросов. Использовать дефолтные ответы (например, отвечать «да» на вопросы про сохранение оригинальных файлов). Обязательно в CI/скриптах.",
            },
            {
...
#     squashed-миграцию, не смогут перейти на новую версию кода.`,
    },
    {
        ...
        syntax: "manage.py startapp name [directory] [--template TEMPLATE] [--extension EXTENSIONS/-e EXTENSIONS] [--name FILES/-n FILES] [--exclude DIRECTORIES/-x DIRECTORIES]",
        arguments: [
            {
                name: "name",
                description:
...
#     name = '{{ app_name }}'`,
    },
    {
        ...
        syntax: "django-admin startproject name [directory] [--template TEMPLATE] [--extension EXTENSIONS/-e EXTENSIONS] [--name FILES/-n FILES] [--exclude DIRECTORIES/-x DIRECTORIES]",
        arguments: [
            {
                name: "name",
                description:
...
# {{ secret_key }}              — автогенерируемый SECRET_KEY (для settings.py)`,
    },
    {
        ...
        syntax: "manage.py test [test_label [test_label ...]] [--failfast] [--testrunner TESTRUNNER] [--noinput/--no-input] [--keepdb] [--shuffle [SEED]] [--reverse/-r] [--debug-mode] [--debug-sql/-d] [--parallel [N]] [--tag TAGS] [--exclude-tag EXCLUDE_TAGS] [-k TEST_NAME_PATTERNS] [--pdb] [--buffer/-b] [--no-faulthandler] [--timing] [--durations N]",
        arguments: [
            {
...
$ python manage.py test --noinput --parallel --shuffle --buffer --timing`,
    },
    {
        ...
        syntax: "manage.py testserver [fixture [fixture ...]] [--addrport ADDRPORT] [--noinput/--no-input]",
        arguments: [
            {
                name: "fixture [fixture ...]",
                description:
...
#     тот и устанавливает новый. Защищайте доступ к серверу/manage.py.`,
    },
    {
        ...
        syntax: "manage.py createsuperuser [--noinput/--no-input] [--username USERNAME] [--email EMAIL] [--database DATABASE]",
        arguments: [
            {
                name: "--noinput, --no-input",
                description:
...
#     установка пароля (changepassword или set_password в shell).`,
    },
    {
        ...
        syntax: "manage.py remove_stale_contenttypes [--database DATABASE] [--include-stale-apps]",
        arguments: [
            {
                name: "--database DATABASE",
                description:
